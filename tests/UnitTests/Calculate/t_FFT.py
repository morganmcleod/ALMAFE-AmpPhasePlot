...
def makeFFTSamples():
    ...
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "1 - 40.png")
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "2 - 40 at 0.5.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "3 - sin^2.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "4 - sin^2 at 0.5.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "5 - 40+90.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "6 - 40+90 at 0.5.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "7 - 40+43 resolvable.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotTimeSeries(tsId, dict(tsEls), show = False)
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "8 - 40+40.5 unresolvable.png")
    tsAPI.deleteTimeSeries(tsId)
    ...
    plotAPI.plotPowerSpectrum(tsId, dict(fftEls), outputName = "9 - normal noise FFT.png")
    tsAPI.deleteTimeSeries(tsId)
